...
public class Regulamin extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
...
/////////////////////////////
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if (id == R.id.Strona_Glowna) {
            Intent intent = new Intent(Regulamin.this, MainSite.class);
            startActivity(intent);
            Toast toast = Toast.makeText(context, "Strona Główna", duration);
            toast.show();
        }
        if (id == R.id.Twoj_Profil) {
            Intent intent = new Intent(Regulamin.this, Twoj_Profil.class);
            startActivity(intent);
            Toast toast = Toast.makeText(context, "Twój profil", duration);
            toast.show();
        }
        if (id == R.id.Promocje) {
            Intent intent = new Intent(Regulamin.this, Promocje.class);
            startActivity(intent);
            Toast toast = Toast.makeText(context, "Promocje", duration);
            toast.show();
        }
        if (id == R.id.Nowosci) {
            Intent intent = new Intent(Regulamin.this, Nowosci.class);
            startActivity(intent);
            Toast toast = Toast.makeText(context, "Nowości", duration);
            toast.show();
        }
        if (id == R.id.Pomoc) {
            Intent intent = new Intent(Regulamin.this, Pomoc.class);
            startActivity(intent);
            Toast toast = Toast.makeText(context, "Pomoc", duration);
            toast.show();
        }
        if (id == R.id.Regulamin) {
            Intent intent=new Intent(Regulamin.this,Regulamin.class);
            startActivity(intent);
